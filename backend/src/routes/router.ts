...
import ListUsersController from "../controller/user/ListAllUserController";
import FindUserByIdController from "../controller/user/FindUserByIdController";
import UpdateUserController from "../controller/user/UpdateUserController";

import AuthUserController from "../controller/user/LoginControlle";
import isAuthenticated from "../middleware/authUserService";
import { SearchUserByNameController } from "../controller/user/SearchUserByNameController";
import { RecoveryController } from "../controller/user/recoveryController";
...
import { InactivateUserController } from "../controller/user/InactivateUserController";
